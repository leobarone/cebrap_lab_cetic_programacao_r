...
Á época em que foi apresentado, a API do Google Maps não exigia seu cartão de crédito para acessá-la. Infelizmente, agora é preciso informar quem você é antes de obter um simples mapa.
